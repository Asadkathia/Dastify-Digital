...
export const defaultContent: PageContent = {
  ...
  nav: {
    logo: { text: "Dastify", accent: ".Digital", href: "/" },
    links: [
      { label: "Home", href: "/" },
  ...
  hero: {
    ...
    ctas: [
      { label: "Meet The Team →", href: "/contact", variant: "dark" },
      { label: "See Our Work", href: "/work", variant: "outline" }
    ],
    stats: [
      { value: "50+", label: "Healthcare Clients Served" },
      { value: "$40M+", label: "Patient Revenue Generated" }
    ],
    visual: { icon: "🏥", label: "Hero Visual", dimensions: "580 × 520px" },
    marquee: [
      "Healthcare SEO",
      "•",
      "Patient Acquisition",
  ...
  team: {
    ...
    stats: [
      { value: "25+", label: "Healthcare Specialists" },
      { value: "120+", label: "Combined Years" }
    ],
    cta: { label: "Meet The Full Team →", href: "/team" },
    visuals: [
      { icon: "👥", label: "Team Photo 1", dimensions: "320 × 400px", height: "400px", className: "about-team-img-1" },
      { icon: "💼", label: "Team Photo 2", dimensions: "280 × 188px", height: "188px", className: "about-team-img-2" },
      { icon: "🎯", label: "Team Photo 3", dimensions: "280 × 188px", height: "188px", className: "about-team-img-3" }
    ]
  },
  values: {
    chip: "Our Values",
  ...
  cta: {
    ...
    buttons: [
      ...
      { label: "See Case Studies", href: "/work", variant: "ghost" }
    ]
  },
  footer: {
    brand: {
    ...
    columns: [
      ...
      },
      {
        title: "Contact",
        links: [
          { label: "Book a Strategy Call", href: "/contact", highlight: true },
          { label: "hello@dastify.digital", href: "mailto:hello@dastify.digital" },
