...
export const defaultContent: PageContent = {
  meta: {
    ...
    description:
      "Six HIPAA-compliant marketing services built for healthcare. SEO, PPC, content, social, web design, and reputation management — all measured in patients, not pageviews.",
  },
  nav: {
    logoText: "Dastify",
    logoAccent: ".Digital",
  ...
  hero: {
    ...
    lead:
      "Every service is built for healthcare. HIPAA-compliant tracking. Patient journey mapping. Revenue attribution you can actually trust. No generalist guesswork—just measurable growth.",
    ...
    items: [
      {
        ...
        description:
          'Patients searching for "orthopedic surgeon near me" or "best dermatologist Dallas" should find you first. We make that happen—with SEO built for healthcare\'s unique ranking factors.',
        cta: { label: "Learn More →", href: "/services/seo" },
      },
      {
        id: "ppc",
        number: "02",
        ...
        description:
          "Healthcare PPC is full of landmines—disapproved ads, tracking restrictions, compliance headaches. We navigate all of it so you can focus on what matters: more patients calling.",
        cta: { label: "Learn More →", href: "/services/ppc" },
      },
      {
        id: "content",
        number: "03",
        ...
        description:
          "Patients research before they book. Our content answers their questions, builds authority, and guides them to your practice—not your competitor's.",
        cta: { label: "Learn More →", href: "/services/content" },
      },
      {
        id: "social",
        number: "04",
        ...
        description:
          "Social media for healthcare isn't about going viral. It's about building trust, showcasing your team, and staying top-of-mind when patients need you.",
        cta: { label: "Learn More →", href: "/services/social" },
      },
      {
        id: "web",
        number: "05",
        ...
        description:
          "Your website is your 24/7 front desk. We build sites that load fast, look professional, and make it effortless for patients to book—on any device.",
        cta: { label: "Learn More →", href: "/services/web" },
      },
      {
        id: "reputation",
        number: "06",
        ...
        description:
          "87% of patients check reviews before booking. We help you systematically collect positive reviews while managing the occasional negative one with grace.",
        cta: { label: "Learn More →", href: "/services/reputation" },
      },
    ],
  },
  results: {
    ...
    stats: [
      { value: "+309%", label: "Organic Traffic" },
      { value: "8.2x", label: "PPC ROI" },
  ...
  why: {
    ...
    lead:
      "Generic agencies learn your industry on your dime. We already know it—because we've worked inside it. Here's what makes healthcare different.",
    cards: [
      {
        icon: "🔒",
        title: "HIPAA Compliance",
        description:
          "Tracking pixels, form data, remarketing audiences—all require PHI-safe handling. One mistake can mean a breach.",
      },
      {
        icon: "📋",
        title: "Platform Restrictions",
        description:
          "Google and Meta have specific healthcare ad policies. We know them cold—and how to work within them.",
      },
      {
        icon: "🏥",
        title: "Patient Journeys",
        description:
          "A dermatology patient researches differently than a bariatric surgery candidate. We map every touchpoint.",
      },
      {
        icon: "📊",
        title: "Revenue Attribution",
        description:
          "Impressions don't pay bills. We connect marketing spend to actual appointments and patient revenue.",
      },
    ],
  },
  process: {
    ...
    intro:
      "Every engagement starts with understanding your practice, your patients, and your goals.",
    steps: [
      {
        number: "1",
        title: "Market Audit",
        description:
          "We study your competitors, your patients, and your current marketing performance.",
      },
      {
        number: "2",
        title: "Strategy",
        description:
          "Campaign structure, channel selection, compliance framework—all built for your goals.",
      },
      {
        number: "3",
        title: "Build",
        description:
          "Copy, design, landing pages, tracking—everything built to healthcare standards.",
      },
      {
        number: "4",
        title: "Launch",
        description:
          "Phased rollout with real-time monitoring to catch issues before they cost you.",
      },
      {
        number: "5",
        title: "Optimize",
        description:
          "Monthly reviews, data-driven iteration, and continuous improvement.",
      },
    ],
    placeholderIcon: "🎯",
  ...
  cta: {
    ...
    subtext:
      "30 minutes. No pitch deck. We'll audit your current marketing and show you where the opportunities are.",
  ...
  footer: {
    ...
    logoAccent: ".Digital",
    tagline:
      "The creative authority for healthcare growth. HIPAA-compliant, AI-powered, obsessively measurable.",
    columns: [
      {
        title: "Services",
        links: [
          { label: "Healthcare SEO", href: "/services/seo" },
          { label: "Medical PPC", href: "/services/ppc" },
      ...
      },
      {
        title: "Verticals",
        links: [
          { label: "Specialty Practices", href: "/verticals/specialty" },
          { label: "Dental & DSOs", href: "/verticals/dental" },
          { label: "Behavioral Health", href: "/verticals/behavioral" },
          { label: "Senior Care", href: "/verticals/senior" },
          { label: "Urgent Care", href: "/verticals/urgent" },
          { label: "Med Spas", href: "/verticals/medspa" },
        ],
      },
      {
        title: "Contact",
        links: [
          ...
          { label: "hello@dastify.digital", href: "/contact" },
